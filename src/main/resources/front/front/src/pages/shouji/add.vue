...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="付款人数" prop="realsales">
            <el-input v-model="ruleForm.realsales" 
                placeholder="付款人数" clearable :disabled=" false  ||ro.realsales"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="商家" prop="shopname">
            <el-input v-model="ruleForm.shopname" 
                placeholder="商家" clearable :disabled=" false  ||ro.shopname"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="机身颜色" prop="jcolor">
            <el-input v-model="ruleForm.jcolor" 
                placeholder="机身颜色" clearable :disabled=" false  ||ro.jcolor"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="存储容量" prop="ccsize">
            <el-input v-model="ruleForm.ccsize" 
                placeholder="存储容量" clearable :disabled=" false  ||ro.ccsize"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="型号" prop="xinghao">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="分辨率" prop="fenbianlv">
            <el-input v-model="ruleForm.fenbianlv" 
                placeholder="分辨率" clearable :disabled=" false  ||ro.fenbianlv"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="3C证书编号" prop="bianhao">
            <el-input v-model="ruleForm.bianhao" 
                placeholder="3C证书编号" clearable :disabled=" false  ||ro.bianhao"></el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`shouji/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('shouji/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`shouji/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
