		...
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"30%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="shoujiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"40px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="shoujiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"10px","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%","display":"flex","width":"100%","fontSize":"14px","height":"calc(30% - 20px)","order":"2"}'>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,0)","justifyContent":"center","display":"flex"}'>
						...
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>手机总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{shoujiCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 0px 0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,0)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px"}'>手机</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#5c89e6","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="jcolor" label="机身颜色"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="ccsize" label="存储容量"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="xinghao" label="型号"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="pinpai" label="品牌"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="fenbianlv" label="分辨率"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="shoujiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"40px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="shoujiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'shoujiChart1');
...
//统计接口2
    shoujiChat2() {
      this.$nextTick(()=>{
        ...
        var shoujiChart2 = echarts.init(document.getElementById("shoujiChart2"),'macarons');
        this.$http({
...
//统计接口3
    shoujiChat3() {
      this.$nextTick(()=>{
        ...
        var shoujiChart3 = echarts.init(document.getElementById("shoujiChart3"),'macarons');
        this.$http({
...
//统计接口4
    shoujiChat4() {
      this.$nextTick(()=>{
        ...
        var shoujiChart4 = echarts.init(document.getElementById("shoujiChart4"),'macarons');
        this.$http({
